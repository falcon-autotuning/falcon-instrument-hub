...
type TypedParameter struct {
	...
	Dbmeta        *DataBufferMetadata    `protobuf:"bytes,5,opt,name=dbmeta,proto3" json:"dbmeta,omitempty"` // Additional metadata for DataBuffer
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TypedParameter) GetUnit() string {
	if x != nil {
		return x.Unit
	}
	return ""
...
const file_instserver_daemon_v1_daemon_messages_proto_rawDesc = "" +
	...
	"\x0finstrument_name\x18\x06 \x01(\tR\x0einstrumentName\"\xe9\x01\n" +
	"\x0eTypedParameter\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x122\n" +
	"\x04type\x18\x02 \x01(\x0e2\x1e.instserver.daemon.v1.LuaTypesR\x04type\x129\n" +
	"\x05value\x18\x03 \x01(\v2#.instserver.daemon.v1.VariableValueR\x05value\x12\x12\n" +
	"\x04unit\x18\x04 \x01(\tR\x04unit\x12@\n" +
	"\x06dbmeta\x18\x05 \x01(\v2(.instserver.daemon.v1.DataBufferMetadataR\x06dbmeta\"\x95\x02\n" +
	"\rCommandResult\x12'\n" +
